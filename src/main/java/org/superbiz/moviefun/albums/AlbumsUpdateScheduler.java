...
public class AlbumsUpdateScheduler {
    ...
    private final DataSource albumsUpdateScheduler ;



    public AlbumsUpdateScheduler(AlbumsUpdater albumsUpdater, DataSource albumsUpdateScheduler) {
        this.albumsUpdater = albumsUpdater;
        this.albumsUpdateScheduler = albumsUpdateScheduler;
    }
    ...
    private boolean startAlbumSchedulerTask() {
        ...
        JdbcTemplate jdbcTemplate =  new JdbcTemplate(albumsUpdateScheduler);
